...
export const data = {
  ...
  questions: [
    {
      id: 1,
      title: 'Javascript jest językiem synchronicznym czy asynchronicznym?',
      answer: '<p>Javascript może być synchroniczny oraz asynchroniczny. Przez większość czasu używamy go w sposób synchroniczny.</p>',
      keywords: [],
      category: ['javascript'],
    },
    {
...
// <div (click)="click1($event)">
// click1
// <div (click)="click2($event)">
// click2
// <div (click)="click3($event)">
//   click3
//   </div>
// </div>
// </div>
